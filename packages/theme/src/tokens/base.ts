 ...
 *
 * @see https://design-tokens.github.io/community-group/
 */
export const baseTokens: ThemeConfig = {
  /**
   * Color system with semantic and brand colors
   * Using a numeric scale from 50 (lightest) to 950 (darkest)
   */
  colors: {
    // Brand colors
    primary: {
  ...
  /**
   * Typography system with consistent font families, sizes, weights, and spacing
   */
  typography: {
    fontFamily: {
   ...
   * Using a geometric progression for visual harmony
   */
  spacing: {
    0: '0px',
    px: '1px',
  ...
  /**
   * Animation system for durations, easing curves, and transitions
   */
  animation: {
    duration: {
      75: '75ms',
